...
@Target({ElementType.FIELD, ElementType.PARAMETER}) //Annotasyonun uygulanabileceği yerleri belirtir.
@Retention(RetentionPolicy.RUNTIME) //Annotasyonun çalışma zamanında kullanılacağını belirtir.
@Constraint(validatedBy = NotFutureYearValidator.class) //Annotasyonun hangi sınıf tarafından kontrol edileceğini belirtir.
